...
export class SpotifyService {
  ...
  getQuery( query: string ) {
    ...
    const headers = new HttpHeaders({
      'Authorization': 'Bearer BQCtCyXwhVBt3eFyqCdWLY35aVzs5ZFcCNM_q3F5Lj6w-mT7BvftyRkWQ2W1Y1DGEPqqWUlMwUElKbGIKz4'
    });
  ...
  getNewReleases(){
    ...
    //const headers = new HttpHeaders({'Authorization':'Bearer BQDngOeYhZeL8N1OQN2_cJo-jUvlEJC8znB3POw3kVQ4kyuC2flAka_Cmd6Efxk5wSMUrbH5fxkjWOeBvPY'});
